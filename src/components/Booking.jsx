  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-3 gap-4">
        ...
        <Counter label="Children/Youth" value={children} setValue={setChildren} />
        <Counter
      ...
      <div className="p-4 rounded-xl bg-white shadow">
        ...
        <ul className="text-sm text-slate-700 space-y-1">
          <li>Adults: {adults} × NOK {ADULT_PRICE}</li>
          <li>Children/Youth: {children} × NOK {CHILD_PRICE}</li>
          <li>Total Guests: {totalGuests}</li>
          <li>Drinks: {drinks} / {maxDrinksAllowed}</li>
        </ul>
